...
@Component({
  selector: 'nexus-projetos-acoes',
  templateUrl: './projetos-acoes.component.html',
  styleUrl: './projetos-acoes.component.scss'
})
  ...
  deletarObjeto(): void {
    ...
    .subscribe({
      next: () => {
        ...
        this.deletou.emit();
        this.mostrarSnackBarOk('Projeto deletado com sucesso!');
      },
