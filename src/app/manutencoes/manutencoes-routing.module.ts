...
const routes: Routes = [
  ...
  children: [
    ...
    { path: 'adicionar/:componente-uid', canDeactivate:[sairFormulario], component: ManutencoesAdicionarComponent },
    { path: 'buscar', component: ManutencoesBuscarComponent },
    { path: 'detalhes/:uid', component: ManutencoesDetalhesComponent },
    { path: 'editar/:uid', canDeactivate:[sairFormulario], component: ManutencoesEditarComponent },
  ]}
];
