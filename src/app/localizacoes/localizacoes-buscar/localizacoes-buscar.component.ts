...
export class LocalizacoesBuscarComponent {
  colunas: string[] = ['name', 'weight', 'symbol'];
  colunasMostrarComo : string[] = [ 'Nome', 'Peso (KG)', 'Símbolo']
  dados = new MatTableDataSource<PeriodicElement>(ELEMENT_DATA);
