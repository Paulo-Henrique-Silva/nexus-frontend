...
@Component({
  ...
  styleUrl: './componentes-editar.component.scss'
})
export class ComponentesEditarComponent extends NexusFormulario implements OnInit {
    ...
    .subscribe({
      next: (componente) => {
        ...
        this.formulario.setValue({
          ...
          localizacao: componente.localizacao.uid,
          tipo: Number(componente.tipo.uid),
  ...
  override onSubmit(): void {
    ...
    this.service.editar(uid, componente)
      .subscribe({
        next: () => {
          this.mostrarSnackBarOk('Componente editado com sucesso!');
          this.carregando = false;
